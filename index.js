...
*/
const XPTN = '👾VARGAS_250👾'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/VARGAS_250/'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/6281227560249'; // Nomor whatsapplu cok
const aktif = 'Tergantung jaringan'; // Kapan bot lu aktif
const groupwa = 'https://chat.whatsapp.com/BkH2qUhWSHFGgbjSDGmL2e'; // OFFICIAL GRUP LU 1
const youtube = 'https://youtube.com/channel/UCNUXc-wvktd1xmH9HLEpnWQ'; // OFFICIAL GRUP LU 2
//
...
else if (text == '.groupbot2'){
conn.sendMessage(id, 'group bot whatsapp https://chat.whatsapp.com/HzWf7Lq3bIHC9yGzVLEpkR' ,MessageType.text);
}
else if (text == '.groupbot1'){
conn.sendMessage(id, 'group bot whatsapp https://chat.whatsapp.com/BkH2qUhWSHFGgbjSDGmL2e' ,MessageType.text);
}
...
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://Wa.me/6281227560249* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh .help' ,MessageType.text);
}
